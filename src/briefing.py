...
四个时段，四种内容：
  09:00  美股昨夜收盘复盘 + 亚太今日前瞻 + AI 解读
  12:00  午间快讯（A股/港股午盘异动 + 要闻）
  14:30  收盘前快讯 + Python 硬核操作指令
  19:00  夜盘前瞻 + AI 解读（新闻对持仓的影响）

全部资讯来自免费源（金十数据 + 华尔街见闻），零成本。

用法：
  python -m src.briefing 09:00
"""
...
BRIEFINGS = {
    "09:00": ("☀️ 早间简报", _build_morning),
    "12:00": ("🌤️ 午间快讯", _build_midday),
    "14:30": ("⚡ 收盘前指令", _build_preclose),
    "19:00": ("🌆 夜盘前瞻", _build_evening),
}
