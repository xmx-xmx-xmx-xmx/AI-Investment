...
| 测试 | **278 用例**，覆盖 11 个模块（macro_calendar / market_data / global_news / radar / strategy / briefing-diff / **hard-signals** / **briefing-snapshot** / convert / holding-match / **resolver-batch**）；实测 `pytest -q` 全绿 |
...
| 底仓数据完整性 | ⚠️ **2 行待修**（2026-09-19 事故，见 §1.5）：C 类 `278.23 → 28.23`、E 类 `16.22 → 293.70` |
