...
| 测试 | **337 用例**，覆盖 14 个模块（macro_calendar / market_data / global_news / radar / strategy / briefing-diff / **hard-signals** / **briefing-snapshot** / convert / holding-match / **resolver-batch** / **sector-brief** / **macro-brief** / **output-hygiene**）；实测 `pytest -q` 全绿 |
